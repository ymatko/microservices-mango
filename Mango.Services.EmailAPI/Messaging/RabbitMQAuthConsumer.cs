...
namespace Mango.Services.EmailAPI.Messaging
{
    public class RabbitMQAuthConsumer : BackgroundService
    {
        ...
        public RabbitMQAuthConsumer(IConfiguration configuration, EmailService emailService)
        {
            ...
            _channel.QueueDeclare(_configuration.GetValue<string>("TopicAndQueueNames:RegisterUsertQueue"), false, false, false, null);
        }
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            _channel.BasicConsume(_configuration.GetValue<string>("TopicAndQueueNames:RegisterUsertQueue"), false, consumer);
