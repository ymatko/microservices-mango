...
namespace Mango.Services.RewardAPI.Messaging
{
    public class AzureServiceBusConsumer : IAzureServiceBusConsumer
    {
        ...
        public AzureServiceBusConsumer(IConfiguration configuration, RewardService rewardService)
        {
            ...
            orderCreatedTopic = _configuration.GetValue<string>("TopicAndQueueNamse:OrderCreatedTopic");
            orderCreatedRewardSubscription = _configuration.GetValue<string>("TopicAndQueueNamse:OrderCreated_Rewards_Subscription");
